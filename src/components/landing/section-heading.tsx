  ...
  return (
    <div className={`flex flex-col gap-4 ${alignmentClasses[align]}`}>
      ...
      <div className="flex gap-2 flex-col">
        <h2 className="text-3xl md:text-5xl tracking-tighter font-bold text-gray-950">
          {title}
        </h2>
        {description && (
          <p className="text-lg max-w-xl lg:max-w-2xl leading-relaxed tracking-tight text-gray-600">
            {description}
          </p>
        )}
      </div>
